...
function Home() {
    ...
    const handleDeleteCard = async (id, e)=>{
        e.stopPropagation();
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].delete(`/funding/methods/${id}`);
            await fetchData();
